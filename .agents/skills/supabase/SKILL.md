...
First, fetch [https://supabase.com/changelog.md](https://supabase.com/changelog.md) (a lightweight summary index — not a heavy pull), scan for `breaking-change` tags relevant to your task, and follow the linked page for any that apply. Then look up the relevant topic using the documentation access methods below.
...
For any security concern not covered above, fetch the Supabase product security index: [https://supabase.com/docs/guides/security/product-security.md](https://supabase.com/docs/guides/security/product-security.md)
