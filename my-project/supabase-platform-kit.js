...
// types: paths (TypeScript-only) removed for JS runtime
...
async function getDbSchema(projectRef) {
...
export async function POST(request) {
  ...
  // Note: this file is a server-side handler for Supabase management API
  // The client-side example component was removed to keep this module server-only.
